...
class ML_Features_Rec():
    ...
    def read_features(self,axis):
        test_features_path = fr'src/ml_cf_features_pca/other_test_features_pca_mat-{axis}.npy'
...
if __name__ == '__main__':
    ...
    for axis in ['9axis', '6axis']:
        ...
        savePath = f'src/ml_cf_plt_img/Classifier_Confusion_Matrix_Amateur_{axis}.png'
