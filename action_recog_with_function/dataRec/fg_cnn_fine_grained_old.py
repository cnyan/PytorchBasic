...
class Extract_1D_2D_features():
    def __init__(self, modelNet, model_name, axis, data_category):
        ...
        self.model.load_state_dict(torch.load(f'src/model/{model_name}_{axis}_model_old.pkl', map_location='cpu'))
    ...
    def extract_features(self):
        ...
        for inputs in self.action_train_data_gen:
            ...
            fusion_features = conv1d_features.numpy() + conv2d_features.numpy()
...
class FG__vector_Predict_with_kmeans():
    def __init__(self, axis, action_name):
        ...
        self.modelNet.load_state_dict(torch.load(f'src/model/MyMultiTempSpaceConfluenceNet_{axis}_model_old.pkl', map_location='cpu'))
        self.modelNet.eval()
