...
class FG_Predict():
    def __init__(self, model_name='1'):
        self.model = torch.load('src/model/fg_cnn_model_' + model_name + '.pkl')
        self.model.eval()
        self.test_action_data_set = Input_Data("src/nodeData/test/test_action_data_" + model_name + ".npy")
